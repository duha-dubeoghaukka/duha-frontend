...
const RegionButtonContent = ({ name }) => {
  return (
    <p className="border-2 border-green1 cursor-pointer px-4 py-2 rounded-full font-semibold text-sm hover:bg-green1 hover:text-white transition-all ease-in-out">
      {name}
    </p>
  );
};
