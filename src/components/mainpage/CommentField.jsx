...
const CommentField = ({ comment, setComment, commentRegisterHandler }) => {
  ...
  return (
    <div className="grid grid-cols-[1fr_80px] gap-3">
      <input
        type="text"
        className="border-green1 border-2 rounded-lg p-2 pl-5 text-black1 disabled:border-gray-200 disabled:bg-gray-200 placeholder:text-white1 disabled:placeholder:text-black1 disabled:cursor-not-allowed"
        value={comment}
