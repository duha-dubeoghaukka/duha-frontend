...
function LinkModal({ modalHandler, route, title }) {
  ...
  return (
    <div className="fixed inset-0 z-10 overflow-y-auto">
      <div className="fixed inset-0 w-full h-full bg-black opacity-40" onClick={() => modalHandler()}></div>
        ...
        <div className="relative w-full max-w-lg p-4 mx-auto bg-white rounded-md shadow-lg">
          <div className="md:mt-2">
            ...
            <div className="md:mt-1 text-center">
              ...
              <div className="flex flex-row m-4 md:m-7 place-content-center space-x-11">
