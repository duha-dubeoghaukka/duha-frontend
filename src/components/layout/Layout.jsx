  ...
  return (
    <div>
      <div className="fixed w-full py-[31px] bg-[#7FB77E] z-10">
        <div>
          <h1 className="text-[#F6F6F6] font-bold text-[26px] text-center">{title}</h1>
          <p
            className="absolute font-bold text-[26px] right-10 top-[31px] text-[#F6F6F6] cursor-pointer">{isLoggedIn ? "로그아웃" : "로그인"}</p>
        </div>
      </div>
      <div className="fixed w-[290px] mt-[100px] border-r-2 h-full">
        ...
        <div className="ml-[54px]">
          <div className="mb-[28px]">
            <div
              className={`flex items-center mb-[8px] cursor-pointer ${greaterCategory === "mainpage" && "text-[#7FB77E]"}`}>
          ...
          <div className="mb-[28px]">
            <div
              className={`flex items-center mb-[8px] cursor-pointer ${greaterCategory === "schedule" && "text-[#7FB77E]"}`}>
          ...
          <div>
            <div
              className={`flex items-center mb-[8px] cursor-pointer ${greaterCategory === "mypage" && "text-[#7FB77E]"}`}>
      ...
      <div className="w-[600px] mx-auto pt-[130px] border-l-2 border-r-2 px-[24px]">{children}</div>
    </div>
  );
};
